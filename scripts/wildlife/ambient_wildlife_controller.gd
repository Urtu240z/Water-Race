...
const SEAGULL_SCENE: PackedScene = preload("res://Seagull.glb")
const DOLPHIN_SCENE: PackedScene = preload("res://Dolphin.glb")
const FISH_SCENE: PackedScene = preload("res://Fish.glb")
